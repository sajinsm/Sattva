...
import styles from "./CaseStudy1Challenge.module.css";
const CaseStudy1Challenge = () => {
  ...
  return (
    <div className={styles.caseStudy1Challenge}>
      <div className={styles.postBodyParent}>
        ...
        <div className={styles.howToSectionWrapper}>
          <div className={styles.howToSection}>
            <div className={styles.howToSection}>
              <div
                className={styles.theWebsiteOf}
              >{`The website of a wold - renowned institution needs to be effectively evaluated for compliance with Section 508 guidelines. Manually evaluating the accessibility of numerous web pages is time-consuming and limited in scope. There is a need to identify and address accessibility barriers across the entire website in an efficient and automated manner. `}</div>
