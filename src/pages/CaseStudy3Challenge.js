...
import styles from "./CaseStudy3Challenge.module.css";
const CaseStudy3Challenge = () => {
  ...
  return (
    <div className={styles.caseStudy3Challenge}>
      <div className={styles.postBodyParent}>
        ...
        <div className={styles.howToSectionWrapper}>
          <div className={styles.howToSection}>
            <div className={styles.howToSection}>
              <div
                className={styles.theDepartmentOf}
              >{`The Department of Education needed the different agency websites to be effectively evaluated to ensure compliance with Section 508 and WCAG (Web Content Accessibility Guidelines) standards. Manually evaluating the accessibility of numerous web pages was time-consuming and limited in scope. There was a need to identify and address accessibility barriers across the different websites in an efficient and automated manner. `}</div>
...
export default CaseStudy3Challenge;
